...
if (CModule::IncludeModule("iblock")):
    ...
    $my_elements = CIBlockElement::GetList (
        Array("ID" => "ASC"),
        Array("IBLOCK_CODE" => 'TEACHER', 'ID'=>$_REQUEST['elementid'],
...
$PROP["STAKE_LESSON"] = $_REQUEST['stakeLesson'];
$PROP["STAKE_LESSON_DEMO"] = $_REQUEST['stakeLessonDemo'];
$PROP["ALLOWANCE_LEVEL"] = $_REQUEST['allowanceLevel'];
